...
//   algorithm.
// windowType: WINDOW_TYPE_NORMAL, WINDOW_TYPE_BORDERLESS, WINDOW_TYPE_FULL_SCREEN,
// WINDOW_TYPE_TOP, WINDOW_TYPE_TOP_PARTIAL, WINDOW_TYPE_LION_FULL_SCREEN, WINDOW_TYPE_BOTTOM,
